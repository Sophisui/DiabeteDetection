...
{
    client.BaseAddress = new Uri(builder.Configuration["GatewayUrl"] ?? "http://gateway:8080/");
});
    ...
    .AddJwtBearer(options =>
    {
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            IssuerSigningKey = new SymmetricSecurityKey(
                Encoding.UTF8.GetBytes(builder.Configuration["Jwt:Key"] ?? "SuperSecretKey123!SuperSecretKey123!"))
        };
    });
